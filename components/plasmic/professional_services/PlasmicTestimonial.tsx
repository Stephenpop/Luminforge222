...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: Q0E_v9ce4bk7/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__lusdu)}
      >
        {renderPlasmicSlot({
          defaultContents:
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___8OdOo)}
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__gnHq9)}
                displayHeight={"64px"}
              ...
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__vpwSd)}
              >
                <div
                  className={classNames(projectcss.all, sty.freeBox___4TcxO)}
                >
                  <h5
                    className={classNames(
                      projectcss.all,
